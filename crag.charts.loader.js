class CragLoader {
	...
	resources = {
		core: {
			js: 'crag.charts.core.0.4.0.js',
			css: 'crag.charts.core.0.2.0.css'
		},
		column: {
			js: 'crag.column.1.2.0.js',
		...
		lines: {
			js: 'crag.lines.1.3.0.js',
			css: 'crag.lines.1.0.2.css'
		},
		combo: {
			js: ['crag.lines.1.3.0.js', 'crag.column.1.2.0.js', 'crag.combo.1.3.0.js'],
