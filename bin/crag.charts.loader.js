class CragLoader {
    ...
    resources = {
        core: {
            js: 'crag.charts.core.1.2.3.js',
            css: 'crag.charts.core.0.5.0.css'
        },
        column: {
            js: 'crag.column.1.8.3.js',
            css: 'crag.column.1.1.0.css'
        },
        progress: {
            js: 'crag.progress.1.2.0.js',
            css: 'crag.progress.1.2.0.css'
        },
        lines: {
            js: 'crag.lines.1.9.3.js',
            css: 'crag.lines.1.1.0.css'
        },
        combo: {
            js: ['crag.lines.1.9.3.js', 'crag.column.1.8.3.js', 'crag.combo.1.9.2.js'],
            css: ['crag.lines.1.1.0.css', 'crag.column.1.1.0.css', 'crag.combo.1.0.3.css']
        },
        pie: {
            js: 'crag.pie.1.6.1.js',
            css: 'crag.pie.1.1.4.css'
        }
    };
