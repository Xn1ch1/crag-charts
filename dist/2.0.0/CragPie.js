import { attachCssToHead, CragCore, CragPallet, ObjectLength, Title, ToolTip } from './Core.js';

export class CragPie extends CragCore {

    constructor (data, options) {
        super();

        attachCssToHead('CragPie.css');
...
export class Slice extends CragCore {
...
export class Slices extends CragCore {
