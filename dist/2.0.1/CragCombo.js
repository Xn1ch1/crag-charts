 ...
 */
import { Columns } from './CragColumn.js';
import { Lines } from './CragLines.js';
import {
    attachCssToHead,
    CragCore,
    CragPallet,
...
export class CragCombo extends CragCore {
    ...
    constructor (data, options = undefined) {
        ...
        attachCssToHead('CragCombo.css', 'CragLines.css', 'CragColumn.css');
